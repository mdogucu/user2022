...
- Students should get familiar with American Disabilities Act and/or United Nations Convention on the Rights of Persons with Disabilities. 
...
```{r echo=FALSE, fig.align="center", fig.alt="", fig.cap="The speed of cars (mph) and the distances (ft) taken to stop", fig.alt="The scatterplot shows speed ranging from about 0 to 25 on the x-axis and dist ranging from 0 to 120 on the y-axis. There is a moderate positive linear relationship.", fig.height=4}
...
fig.alt="The scatterplot shows speed ranging from about 0 to 25 on the 
x-axis and dist ranging from 0 to 120 on the y-axis. There is a moderate 
